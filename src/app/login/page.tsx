...
import { loginWithGoogle, loginWithEmail } from '@/lib/actions/auth'
      ...
      <div className="w-full max-w-md">
        ...
        <div className="rounded-xl border border-[var(--border)] bg-[var(--surface)] p-6">
          <button
            ...
            className="flex w-full items-center justify-center gap-3 rounded-lg border border-[var(--border)] bg-[var(--background)] px-4 py-3 text-sm font-medium text-[var(--text-primary)] transition-colors hover:bg-[var(--surface-hover)]"
          >
          ...
          <div className="my-6 flex items-center gap-3">
            ...
            <span className="text-xs text-[var(--text-secondary)]">O correo electrónico</span>
            <div className="h-px flex-1 bg-[var(--border)]" />
          </div>
